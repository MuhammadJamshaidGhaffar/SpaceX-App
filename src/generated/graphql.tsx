...
export type LaunchQuery = { __typename?: 'Query', launch?: { __typename?: 'Launch', details?: string | null, mission_name?: string | null, links?: { __typename?: 'LaunchLinks', flickr_images?: Array<string | null> | null } | null, launch_site?: { __typename?: 'LaunchSite', site_name_long?: string | null } | null, rocket?: { __typename?: 'LaunchRocket', rocket_name?: string | null } | null } | null };

export type Launches_QueryVariables = Exact<{ [key: string]: never; }>;


export type Launches_Query = { __typename?: 'Query', launches?: Array<{ __typename?: 'Launch', id?: string | null, mission_name?: string | null, launch_year?: string | null, links?: { __typename?: 'LaunchLinks', flickr_images?: Array<string | null> | null } | null } | null> | null };
...
export const Launches_Document = gql`
    query launches_ {
  launches {
    id
    mission_name
...
/**
 * __useLaunches_Query__
 *
 * To run a query within a React component, call `useLaunches_Query` and pass it any options that fit your needs.
 * When your component renders, `useLaunches_Query` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useLaunches_Query(baseOptions?: Apollo.QueryHookOptions<Launches_Query, Launches_QueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Launches_Query, Launches_QueryVariables>(Launches_Document, options);
      }
export function useLaunches_LazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Launches_Query, Launches_QueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Launches_Query, Launches_QueryVariables>(Launches_Document, options);
        }
export type Launches_QueryHookResult = ReturnType<typeof useLaunches_Query>;
export type Launches_LazyQueryHookResult = ReturnType<typeof useLaunches_LazyQuery>;
export type Launches_QueryResult = Apollo.QueryResult<Launches_Query, Launches_QueryVariables>;